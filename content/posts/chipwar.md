...
My main reference for the story was Chip War, chapter 1 -> 4
I also refered to Virtasium: [How does a Transistor Work?](https://www.youtube.com/watch?v=IcrBqCFLHIY) and [Why the First Computers Were Made Out of Lightbulbs](https://www.youtube.com/watch?v=FU_YFpfDqqA) to better understand and visualise stuff.
Images are generated by Claude Fable 5 (except the replay transistor which is a screenshot from Vertisium video)
Altough I put in maximal effort to write this on my own (I hate AI-slop), I did use Claude for fact-checking and storylining here and there.
