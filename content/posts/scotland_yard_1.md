...
<p>This is part 1 of a two part blog. Part 1 explains the game, and lays out the foundations required for formalisation of the game. It also lists out the various assumptions we are going to consider in the game. <a href="{{< relref "scotland_yard_2.md" >}}">&lsquo;Part 2&rsquo;</a> formalises the game and proves it is PSPACE complete.</p>
